...
<div style="padding-top: 30px;">
    <div
        style="background-color: white; padding: 20px; filter: alpha(opacity=80); opacity: 0.9; z-index: 1000; width: 600px; margin: 200px auto 0 auto;">
        <form class="myform">
            <div class="form-group">
                <div class="controls">
                    <img src="../img/winestorelogin.png" alt="#" class="img-responsive center-block" width="250"
                         height="250" style="padding-top: 5px">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class=" controls">
                    <input id="username" name="username" placeholder="Username"
                           class="form-control input-lg requiredField" type="text" data-error-invalid="Invalid username"
                           data-error-empty="Enter username">
                </div>
            </div>
            <div class="form-group">
